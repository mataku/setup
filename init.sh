...
curl -Lo mitamae-x86_64-darwin.tar.gz https://github.com/itamae-kitchen/mitamae/releases/download/v${MITAMAE_VERSION}/mitamae-x86_64-$suffix.tar.gz
tar -zxf mitamae-x86_64-$suffix.tar.gz
rm mitamae-x86_64-$suffix.tar.gz
